...
namespace Renci.SshNet.Security
{
    ...
    public class RsaKey : Key, IDisposable
    {
        ...
        public RsaKey(BigInteger modulus, BigInteger exponent, BigInteger d, BigInteger p, BigInteger q,
            BigInteger inverseQ)
        {
        ...
        {
            get { return new[] {Exponent, Modulus}; }
            set
            {
                if (value.Length != 2)
                    throw new InvalidOperationException("Invalid private key.");
