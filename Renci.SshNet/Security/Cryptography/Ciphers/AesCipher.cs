...
namespace Renci.SshNet.Security.Cryptography.Ciphers
{
    ...
    public sealed class AesCipher : BlockCipher
    {
            ...
            : base(key, 16, mode, padding)
        {
            ...
            if (!(keySize == 256 || keySize == 192 || keySize == 128))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture,
                    "KeySize '{0}' is not valid for this algorithm.", keySize));
        }
        ...
        ///     <paramref name="inputBuffer" /> or <paramref name="outputBuffer" /> is too
        ///     short.
        /// </exception>
        ...
        private void DecryptBlock(uint[] KW)
        {
            ...
            for (r = _rounds - 1; r > 1;)
            {
                ...
                r3 = Tinv0[C3 & 255] ^ Tinv1[(C2 >> 8) & 255] ^ Tinv2[(C1 >> 16) & 255] ^ Tinv3[C0 >> 24] ^
                     KW[r--*4 + 3];
                ...
                C3 = Tinv0[r3 & 255] ^ Tinv1[(r2 >> 8) & 255] ^ Tinv2[(r1 >> 16) & 255] ^ Tinv3[r0 >> 24] ^
                     KW[r--*4 + 3];
            }
