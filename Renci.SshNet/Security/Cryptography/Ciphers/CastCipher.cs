...
namespace Renci.SshNet.Security.Cryptography.Ciphers
{
    ...
    public sealed class CastCipher : BlockCipher
    {
            ...
            int outputOffset)
        {
            ...
            var L0 = BigEndianToUInt32(inputBuffer, inputOffset);
            var R0 = BigEndianToUInt32(inputBuffer, inputOffset + 4);
            ...
            int outputOffset)
        {
            ...
            // batch the units up into a 32 bit chunk and go for it
            // the array is in bytes, the increment is 8x8 bits = 64
            var L16 = BigEndianToUInt32(inputBuffer, inputOffset);
            var R16 = BigEndianToUInt32(inputBuffer, inputOffset + 4);
