...
namespace Renci.SshNet
{
    ...
    /// </summary>
    /// <example>
    ///     <code source="..\..\Renci.SshNet.Tests\Classes\KeyboardInteractiveConnectionInfoTest.cs"
    ///         region="Example KeyboardInteractiveConnectionInfo AuthenticationPrompt" language="C#"
    ///         title="Connect using interactive method" />
    /// </example>
    public class KeyboardInteractiveConnectionInfo : ConnectionInfo, IDisposable
    {
        ...
        public KeyboardInteractiveConnectionInfo(string host, string username)
            : this(host, DEFAULT_PORT, username, ProxyTypes.None, string.Empty, 0, string.Empty, string.Empty)
        {
        }
        ...
        public KeyboardInteractiveConnectionInfo(string host, int port, string username, ProxyTypes proxyType,
        ...
        /// <param name="proxyHost">The proxy host.</param>
        /// <param name="proxyPort">The proxy port.</param>
        public KeyboardInteractiveConnectionInfo(string host, string username, ProxyTypes proxyType, string proxyHost,
            int proxyPort)
            : this(host, DEFAULT_PORT, username, proxyType, proxyHost, proxyPort, string.Empty, string.Empty)
        {
        }
        ...
        /// <param name="proxyUsername">The proxy username.</param>
        public KeyboardInteractiveConnectionInfo(string host, string username, ProxyTypes proxyType, string proxyHost,
            int proxyPort, string proxyUsername)
            : this(host, DEFAULT_PORT, username, proxyType, proxyHost, proxyPort, proxyUsername, string.Empty)
        {
        }
        ...
        public KeyboardInteractiveConnectionInfo(string host, string username, ProxyTypes proxyType, string proxyHost,
            ...
            : this(host, DEFAULT_PORT, username, proxyType, proxyHost, proxyPort, proxyUsername, proxyPassword)
        {
        }
