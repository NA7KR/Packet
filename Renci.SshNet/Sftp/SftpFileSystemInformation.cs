namespace Renci.SshNet.Sftp
{
    ...
    public class SftpFileSytemInformation
    {
        ...
        internal SftpFileSytemInformation(ulong bsize, ulong frsize, ulong blocks, ulong bfree, ulong bavail,
            ulong files, ulong ffree, ulong favail, ulong sid, ulong flag, ulong namemax)
        {
            BlockSize = frsize;
            TotalBlocks = blocks;
            FreeBlocks = bfree;
