...
namespace Renci.SshNet
{
    ...
    public class NetConfClient : BaseClient
    {
        ...
        public XmlDocument SendCloseRpc()
        {
            ...
            rpc.LoadXml(
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?><rpc message-id=\"6666\" xmlns=\"urn:ietf:params:xml:ns:netconf:base:1.0\"><close-session/></rpc>");
        ...
        protected override void OnConnected()
        {
            ...
            _netConfSession = new NetConfSession(Session, OperationTimeout);
