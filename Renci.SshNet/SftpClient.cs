...
namespace Renci.SshNet
{
    ...
    public partial class SftpClient : BaseClient
    {
        ...
        /// <exception cref="SftpPermissionDeniedException">
        ...
        /// <exception cref="T:Renci.SshNet.Common.SshException">
        ///     A SSH error where <see cref="P:System.Exception.Message" /> is the
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="SftpPermissionDeniedException">
        ///     Permission to change permission on the path(s) was denied by the remote
        ///     host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to create the directory was denied by
        ///     the remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to delete the directory was denied by
        ///     the remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to delete the file was denied by the
        ///     remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        ///     <paramref name="oldPath" /> is <b>null</b>.
        ///     <para>-or-</para>
        ///     or <paramref name="newPath" /> is <b>null</b>.
        /// </exception>
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to rename the file was denied by the
        ///     remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        ///     <para>-or-</para>
        ///     <paramref name="linkPath" /> is <b>null</b> or contains whitespace characters.
        /// </exception>
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to create the symbolic link was denied
        ///     by the remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        /// </returns>
        /// <exception cref="ArgumentException">
        ///     The IAsyncResult object (<paramref name="asyncResult" />) did not come from the
        ///     corresponding async method on this type.
        ///     <para>-or-</para>
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to perform the operation was denied by
        ///     the remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        public bool Exists(string path)
        {
            ...
            var fullPath = _sftpSession.GetFullRemotePath(path);

            if (_sftpSession.RequestRealPath(fullPath, true) == null)
            {
                return false;
            }
            return true;
        ...
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
        /// <exception cref="Renci.SshNet.Common.SftpPermissionDeniedException">
        ///     Permission to upload the file was denied by the
        ///     remote host.
        ///     <para>-or-</para>
        ///     A SSH command was denied by the server.
        /// </exception>
        ...
        ///     thrown by the stream.
        /// </remarks>
        public IAsyncResult BeginUploadFile(Stream input, string path, bool canOverride, AsyncCallback asyncCallback,
            object state, Action<ulong> uploadCallback = null)
        {
            if (input == null)
        ...
        /// <param name="path">The path.</param>
        /// <returns>
        ///     Reference to <see cref="Renci.SshNet.Sftp.SftpFileSytemInformation" /> object that contains file status
        ///     information.
        /// </returns>
        /// <exception cref="System.ArgumentNullException">path</exception>
        /// <exception cref="SshConnectionException">Client is not connected.</exception>
                ...
                result.AddRange(from f in files
                    select
                        new SftpFile(_sftpSession,
                            string.Format(CultureInfo.InvariantCulture, "{0}{1}", basePath, f.Key), f.Value));
        ...
        /// <exception cref="SshConnectionException">Client not connected.</exception>
        private void InternalDownloadFile(string path, Stream output, SftpDownloadAsyncResult asyncResult,
            Action<ulong> downloadCallback)
        {
            ...
            var data = _sftpSession.RequestRead(handle, offset, BufferSize);
            ...
            while (data.Length > 0)
            {
                ...
                data = _sftpSession.RequestRead(handle, offset, BufferSize);
            }
        ...
        /// <exception cref="SshConnectionException">Client not connected.</exception>
        private void InternalUploadFile(Stream input, string path, Flags flags, SftpUploadAsyncResult asyncResult,
            Action<ulong> uploadCallback)
        {
            ...
            do
            {
                ...
                else if (expectedResponses > 0)
                {
                    ...
                    _sftpSession.WaitHandle(responseReceivedWaitHandle, OperationTimeout);
                }
        ...
        protected override void OnConnected()
        {
            ...
            ProtocolVersion = (int) _sftpSession.ProtocolVersion;
        }
        ...
        /// <exception cref="ArgumentException">
        ///     <paramref name="host" /> is invalid.
        ///     <para>-or-</para>
        ///     <paramref name="username" /> is <b>null</b> or contains whitespace characters.
        /// </exception>
        ...
        /// <param name="password">Authentication password.</param>
        /// <exception cref="ArgumentNullException"><paramref name="password" /> is <b>null</b>.</exception>
        /// <exception cref="ArgumentException"><paramref name="host" /> is invalid.
        ///     <para>-or-</para>
        ///     <paramref name="username" /> is <b>null</b> contains whitespace characters.
        /// </exception>
        ...
        ///     <paramref name="host" /> is invalid.
        ///     <para>-or-</para>
        ///     <paramref name="username" /> is nu<b>null</b>ll or contains whitespace characters.
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="port" /> is not within
        ///     <see cref="F:System.Net.IPEndPoint.MinPort" /> and <see cref="System.Net.IPEndPoint.MaxPort" />.
        ...
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is<b>null</b>
        ///     <para>-or-</para>
        ///     <paramref name="contents" /> is <b>null</b>.
        /// </exception>
        ...
        ///     If the file does not exist, this method creates a file, writes the specified string to the file, then closes the
        ///     file.
        /// </summary>
        ...
        {
            return new StreamWriter(OpenWrite(path), Encoding.UTF8);
        }
        ...
        /// <returns>
        ///     A <see cref="System.DateTime" /> structure set to the date and time that the specified file or directory was
        ...
        /// <param name="mode">
        ///     A <see cref="System.IO.FileMode" /> value that specifies whether a file is created if one does not
        ///     exist, and determines whether the contents of existing files are retained or overwritten.
        /// </param>
        /// <returns>
        ///     An unshared <see cref="SftpFileStream" /> that provides access to the specified file, with the specified mode
        ///     and access.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is <b>null</b>.</exception>
        public SftpFileStream Open(string path, FileMode mode)
        {
            return new SftpFileStream(_sftpSession, path, mode, FileAccess.ReadWrite);
        }
        ...
        /// </param>
        /// <param name="access">
        ///     A <see cref="System.IO.FileAccess" /> value that specifies the operations that can be performed on
        ///     the file.
        /// </param>
        /// <returns>
        ///     An unshared <see cref="SftpFileStream" /> that provides access to the specified file, with the specified mode
        ...
        {
            return new SftpFileStream(_sftpSession, path, mode, access);
        }
        ...
        {
            return new SftpFileStream(_sftpSession, path, FileMode.Open, FileAccess.Read);
        }
        ...
        /// <param name="path">The file to be opened for writing.</param>
        /// <returns>
        ///     An unshared <see cref="SftpFileStream" /> object on the specified path with
        ///     <see cref="System.IO.FileAccess.Write" /> access.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is <b>null</b>.</exception>
        ...
        ///     A <see cref="System.DateTime" /> containing the value to set for the last access date and
        ...
        ///     A <see cref="System.DateTime" /> containing the value to set for the last access date
        ///     and time of path. This value is expressed in UTC time.
        /// </param>
        [Obsolete("Note: This method currently throws NotImplementedException because it has not yet been implemented.")
        ]
        ...
        /// <param name="contents">The string array to write to the file.</param>
        /// <param name="encoding">
        ///     An <see cref="System.Text.Encoding" /> object that represents the character encoding applied to
        ///     the string array.
        /// </param>
        /// <exception cref="ArgumentNullException"><paramref name="path" /> is <b>null</b>.</exception>
