namespace Renci.SshNet.Messages.Authentication
{
    ...
    internal class RequestMessageHost : RequestMessage
    {
        ...
        public RequestMessageHost(ServiceName serviceName, string username, string publicKeyAlgorithm,
            byte[] publicHostKey, string clientHostName, string clientUsername)
