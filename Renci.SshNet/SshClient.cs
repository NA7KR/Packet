...
namespace Renci.SshNet
{
    ...
    public class SshClient : BaseClient
    {
        ...
        {
            get { return _forwardedPorts.AsReadOnly(); }
        }
        ...
        public SshCommand CreateCommand(string commandText, Encoding encoding)
        {
            ...
            return new SshCommand(Session, commandText);
        }
        ...
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshCommandTest.NET40.cs"
        ///         region="Example SshCommand RunCommand Parallel" language="C#" title="Run many commands in parallel" />
        /// </example>
        /// <exception cref="ArgumentException">CommandText property is empty.</exception>
        /// <exception cref="T:Renci.SshNet.Common.SshException">
        ///     Invalid Operation - An existing channel was used to execute this
        ///     command.
        /// </exception>
        ...
        /// </returns>
        public Shell CreateShell(Stream input, Stream output, Stream extendedOutput, string terminalName, uint columns,
            uint rows, uint width, uint height, IDictionary<TerminalModes, uint> terminalModes, int bufferSize)
        {
            return new Shell(Session, input, output, extendedOutput, terminalName, columns, rows, width, height,
                terminalModes, bufferSize);
        }
        ...
        /// </returns>
        public Shell CreateShell(Stream input, Stream output, Stream extendedOutput, string terminalName, uint columns,
            uint rows, uint width, uint height, IDictionary<TerminalModes, uint> terminalModes)
        {
            return CreateShell(input, output, extendedOutput, terminalName, columns, rows, width, height, terminalModes,
                1024);
        }
            ...
            IDictionary<TerminalModes, uint> terminalModes, int bufferSize)
        {
            ...
            return CreateShell(_inputStream, output, extendedOutput, terminalName, columns, rows, width, height,
                terminalModes, bufferSize);
        }
        ...
        {
            return CreateShell(encoding, input, output, extendedOutput, terminalName, columns, rows, width, height,
                terminalModes, 1024);
        }
        ...
        /// </returns>
        public ShellStream CreateShellStream(string terminalName, uint columns, uint rows, uint width, uint height,
            int bufferSize)
        {
        ...
        ///         region="Example PasswordConnectionInfo" language="C#" title="Connect using PasswordConnectionInfo object" />
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\PasswordConnectionInfoTest.cs"
        ///         region="Example PasswordConnectionInfo PasswordExpired" language="C#"
        ///         title="Connect using PasswordConnectionInfo object with passwod change option" />
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\PrivateKeyConnectionInfoTest.cs"
        ///         region="Example PrivateKeyConnectionInfo PrivateKeyFile" language="C#"
        ///         title="Connect using PrivateKeyConnectionInfo" />
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect Timeout"
        ///         language="C#" title="Specify connection timeout when connecting" />
        /// </example>
        ...
        /// </exception>
        [SuppressMessage("Microsoft.Reliability", "C2A000:DisposeObjectsBeforeLosingScope",
        ...
        /// <param name="password">Authentication password.</param>
        /// <example>
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs" region="Example SshClient(host, username) Connect"
        ///         language="C#" title="Connect using username and password" />
        /// </example>
        /// <exception cref="ArgumentNullException"><paramref name="password" /> is null.</exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="host" /> is invalid, or <paramref name="username" /> is null or
        ...
        /// <example>
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs"
        ///         region="Example SshClient(host, username) Connect PrivateKeyFile" language="C#"
        ///         title="Connect using username and private key" />
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs"
        ///         region="Example SshClient(host, username) Connect PrivateKeyFile PassPhrase" language="C#"
        ///         title="Connect using username and private key and pass phrase" />
        /// </example>
        ...
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs"
        ///         region="Example SshClient(host, username) Connect PrivateKeyFile" language="C#"
        ///         title="Connect using private key" />
        ///     <code source="..\..\Renci.SshNet.Tests\Classes\SshClientTest.cs"
        ///         region="Example SshClient(host, username) Connect PrivateKeyFile PassPhrase" language="C#"
        ///         title="Connect using private key and pass phrase" />
        /// </example>
        /// <exception cref="ArgumentNullException"><paramref name="keyFiles" /> is null.</exception>
        /// <exception cref="ArgumentException">
        ///     <paramref name="host" /> is invalid, -or- <paramref name="username" /> is null or
